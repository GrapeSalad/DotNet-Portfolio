...
namespace DotNet_Portfolio.Models
{
    public class Github
    {
        ...
        public static JObject SearchForStarredReposByUser(string userName)
        {
            var client = new RestClient("https://api.github.com");
            var request = new RestRequest("/search/repositories?q=user:" + userName + "&sort=stars&order=desc", Method.GET);
